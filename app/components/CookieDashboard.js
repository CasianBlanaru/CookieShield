        ...
        <div className="card mb-6 relative backdrop-blur-sm">
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-1/2 md:pr-4">
              {/* Tabs Navigation */}
              <div className="styled-tabs py-2">
                <button
                  type="button"
                  onClick={() => setActiveTab('text')}
                  className={`styled-tab ${activeTab === 'text' ? 'active' : ''}`}
                >
                  Text Settings
                </button>
                <button
                  ...
                  className={`styled-tab ${activeTab === 'language' ? 'active' : ''}`}
                >
                  Languages
                </button>
                <button
                  ...
                  className={`styled-tab ${activeTab === 'cookie' ? 'active' : ''}`}
                >
                  Cookie Settings
                </button>
                <button
                  ...
                  className={`styled-tab ${activeTab === 'design' ? 'active' : ''}`}
                >
                  Design
                </button>
              </div>
